...
Generated from: UniAdapter.xml,common.xml
    ...
    namespace MavLink
{
	...
	/// 
	/// </summary>
	public enum CONFIG_COMMAND : uint
	{

		/// <summary>
		/// Configuration data reuqest
		/// </summary>
		CONFIG_COMMAND_GET_CONFIGURATION = 0,

		/// <summary>
		/// Firmware Version request
		/// </summary>
		CONFIG_COMMAND_GET_VERSION = 1,

		/// <summary>
		/// Leaves the configuration mode
		/// </summary>
		CONFIG_COMMAND_EXIT = 4,

		/// <summary>
		/// Reboots the MCU into Bootloader mode
		/// </summary>
		CONFIG_COMMAND_BOOTLOADER = 5,

		/// <summary>
		/// Acknowledge a previous Command
		/// </summary>
		CONFIG_COMMAND_ACK = 6,

		/// <summary>
		/// Acknowledge a previous Command
		/// </summary>
		CONFIG_COMMAND_NACK = 7,
	...
	/// 
	/// </summary>
	public enum CONFIG_PORT : uint
	{

		/// <summary>
		/// Port 1 on UniAdapter 1.0
		/// </summary>
		CONFIG_PORT_1 = 1,

		/// <summary>
		/// Port 2 on UniAdapter 1.0
		/// </summary>
		CONFIG_PORT_2 = 2,

		/// <summary>
		/// Port 3 reserverd for future use....
		/// </summary>
		CONFIG_PORT_3 = 3,

		/// <summary>
		/// Port 4 reserverd for future use....
		/// </summary>
		CONFIG_PORT_4 = 4,
	...
	/// 
	/// </summary>
	public enum CONFIG_PROTOCOL : uint
	{

		/// <summary>
		/// Port deactivated
		/// </summary>
		CONFIG_PROTOCOL_NONE = 0,

		/// <summary>
		/// FrSky S.Port Protocol
		/// </summary>
		CONFIG_PROTOCOL_FrSkySPort = 1,

		/// <summary>
		/// Mavlink Protocol
		/// </summary>
		CONFIG_PROTOCOL_MAVLINK = 2,

		/// <summary>
		/// HOTT Telemetrie Protocol
		/// </summary>
		CONFIG_PROTOCOL_HOTT = 3,

		/// <summary>
		/// Jeti Telemetrie Protocol
		/// </summary>
		CONFIG_PROTOCOL_JETI = 4,
...
namespace MavLink
{
	...
	public class Msg_configuration_control : MavlinkMessage
    {
		...
		/// <summary>
		/// Optional, Parameter 1 for Command.
		/// </summary>
		public UInt16 param1;

		/// <summary>
		/// Optional, Parameter 2 for Command.
		/// </summary>
		public UInt16 param2;

        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_CONFIGURATION_CONTROL(this, bytes, ref offset);
            }        
	}

	public class Msg_configuration_version : MavlinkMessage
    {
        ...
        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_CONFIGURATION_VERSION(this, bytes, ref offset);
            }        
	}

	public class Msg_configuration_naza_heartbeat : MavlinkMessage
    {

		/// <summary>
		/// Last Naza Heartbeat in ms. If no Heartbeat UINT16_MAX
		/// </summary>
		public UInt16 lastNazaHeartbeat;

        public override int Serialize(byte[] bytes, ref int offset)
            {
                return MavLinkSerializer.Serialize_CONFIGURATION_NAZA_HEARTBEAT(this, bytes, ref offset);
            }        
	}

	public class Msg_configuration_port : MavlinkMessage
    {
		...
		/// </summary>
		public byte[] data; // Array size 128
